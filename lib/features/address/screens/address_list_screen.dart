                    ...
                    child: Container(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                      ...
                      child: Column(children: [
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Flexible(child: Text('${getTranslated('address', context)} : ${locationProvider.addressList?[index].address}', style: textRegular.copyWith(
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.end, children: [
                          Flexible(
                            child: Text('${getTranslated('city', context)} : ${locationProvider.addressList?[index].city ?? ""}',
