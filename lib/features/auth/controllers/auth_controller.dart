...
class AuthController with ChangeNotifier {
  ...
  Future<ResponseModel>  login (String? userInput, String? password, String? type, FromPage? fromPage) async {
    ...
    ApiResponseModel apiResponse = await authServiceInterface.login(userInput, password, Type);
  ...
  toggleIsNumberLoginScreenText ({bool? value, bool isUpdate = true}) {
    if(value == null) {
  ...
  void removeGoogleLogIn() async {
    // Create a GoogleSignIn instance with default scopes
    final GoogleSignIn googleSignIn = GoogleSignIn.instance;

    // Sign out the user
    await googleSignIn.signOut();

    // Or if you want to completely disconnect the account:
