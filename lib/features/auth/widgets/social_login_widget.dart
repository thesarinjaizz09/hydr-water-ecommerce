...
Future<void> googleLogin(BuildContext context) async {
  ...
  try {
    ...
    if (Provider.of<GoogleSignInController>(Get.context!, listen: false).googleAccount != null) {
      id = Provider.of<GoogleSignInController>(Get.context!, listen: false).googleAccount!.id;
      email = Provider.of<GoogleSignInController>(Get.context!, listen: false).googleAccount!.email;
      token = Provider.of<GoogleSignInController>(Get.context!, listen: false).auth?.idToken;
...
Future<void> facebookLogin(BuildContext context) async {
  ...
  try {
    ...
    final fbController = Provider.of<FacebookLoginController>(Get.context!, listen: false);

    final userData = fbController.userData;
    final accessToken = fbController.result.accessToken;
    ...
    debugPrint('Facebook login error: $er');
  }
}
