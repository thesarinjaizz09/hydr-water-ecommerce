...
class CartScreenState extends State<CartScreen> {
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return AnimatedContainer(
                                color: sellerGroupList[index].id == requiredMinOrderQtyCart?.sellerCart.id
                                    || ((sellerGroupList[index].minimumOrderAmountInfo! > totalCost)
                                        || (configProvider.configModel!.shippingMethod == 'sellerwise_shipping' &&
  ...
  _storeScreenRouteCall (CartModel sellerList) {
