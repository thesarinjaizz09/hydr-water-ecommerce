            ...
            child: Column(children: [
              ...
              DottedBorder(
                ...
                child: ClipRRect(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(3), // ✅ moved padding here
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Padding(
                            ...
                            child: Text(
                              Provider.of<ProfileController>(context, listen: false).userInfoModel?.referCode ?? '',
                          ...
                          child: GestureDetector(
                            onTap: () async {
                              ...
                              await Clipboard.setData(ClipboardData(
                                text: Provider.of<ProfileController>(context, listen: false).userInfoModel?.referCode ?? '',
                              ));
                            },
                            child: Container(
                              width: 85,
